...
public class GdxFrame extends CB_Core.GL_UI.GL_Listener.GL implements ApplicationListener, InputProcessor
{

	private boolean nightMode = false;

	public GdxFrame(int initalWidth, int initialHeight)
	{
	...
	public void switchToMainView(de.gdxFrame.MainView mainView)
	{
